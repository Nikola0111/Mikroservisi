...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .ignoringAntMatchers("/callMe", "/createShoopingCart", "/h2-console/**").and()
                ...
                .authorizeRequests().antMatchers("/hello", "/callMe", "/getCsrf", "/logOut", "/getAllBookings",
                        "/createShoopingCart", "/h2-console/**")
